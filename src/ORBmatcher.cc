...
int ORBmatcher::DescriptorDistance(const cv::Mat &a, const cv::Mat &b)
{
    ...
    {
        unsigned  int v = *pa ^ *pb; // pa의 de-reference ^ pb의 de-reference
        v = v - ((v >> 1) & 0x55555555);
